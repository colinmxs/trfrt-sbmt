...
public class Submit
{
    public record Command(string Grouping, string SubGrouping, string Name, string State, string City, string Country, string Description, string Image, string Website, string Genre, SocialLinksVm Links, ContactInfoVm ContactInfo) : IRequest;
